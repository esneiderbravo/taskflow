...
- [ ] `TaskDependency` model; migration autogenerated (`make migrate-create`) and applied (`make migrate`); stack rebuilt (`make up`)
...
| Migration | `make migrate-create` then `make migrate` then `make up` |
